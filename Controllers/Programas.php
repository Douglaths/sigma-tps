    ...
    public function setPrograma()
    {
        ...
        if ($_POST) {
            if (empty($_POST['txtCodigoPrograma'])) {
                ...
                $strNombrePrograma = strClean(strClean($_POST['txtNombrePrograma']));
                $intHorasPrograma = intval(strClean($_POST['txtHorasPrograma']));
                ...
                if ($request_user > 0) {
                    ...
                    $arrResponse = array('status' => false, 'msg' => '¡Atención! la el programa ya existe, ingrese otro');
                } else {
