                ...
                <div class="tile">
                    <div class="tile-body">
                        <form id="formPrograma" name="formPrograma" enctype="multipart/form-data" method="POST">
                           ...
                           <div class="modal-body">
                                <label for="txtCodigoPrograma">Codigo del Programa<span class="
                                    required">*</span></label>
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" class="form-control valid validText" id="txtNombrePrograma"
                                    name="txtNombrePrograma" required="" maxlength="32"
                                    onkeypress="return controlTag(event);">
                            </div>

                            <div class="modal-body">
                                <label for="txtHorasPrograma">Horas requeridas para el Programa<span class="
                                    required">*</span></label>
                                <input type="text" class="form-control valid validText" id="txtHorasPrograma"
                                    name="txtHorasPrograma" required="" maxlength="32"
                                    onkeypress="return controlTag(event);">
                            </div>

                            <div class="modal-body">
                                <label for="txtNivelPrograma">Nivel del Programa</label>
                                <select class="form-select selectpicker show-tick" id="txtNivelPrograma"
                                    name="txtNivelPrograma" data-live-search="true" data-style="btn-success" required>
                                </select>
                            </div>
